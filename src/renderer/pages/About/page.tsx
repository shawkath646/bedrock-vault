            ...
            <div className="flex flex-col h-full bg-background text-foreground select-none">
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-6 space-y-6">
                    <div className="flex flex-col items-center text-center space-y-3">
                        <div className="p-3.5 rounded-2xl bg-primary/10 text-primary shadow-sm animate-pulse">
        ...
        <div className="flex flex-col h-full bg-background text-foreground select-none">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 space-y-6">
                <div className="flex flex-col items-center text-center space-y-3">
                    ...
                    <div>
                        <h2 className="text-xl font-bold tracking-tight">{appData.name}</h2>
                ...
                <div className="w-full max-w-sm rounded-xl border border-border/60 bg-muted/10 p-4 space-y-2 text-xs">
                    ...
                    <div className="flex justify-between items-center py-0.5">
                        ...
                        <span className="font-medium">{appData.author.name}</span>
                    </div>
                    <div className="flex justify-between items-center py-0.5">
                        <span className="text-muted-foreground">Brand</span>
                        <span className="font-medium">{appData.publishedBy.name}</span>
                    </div>
                </div>

                <div className="text-center text-[10px] text-muted-foreground/80 pt-4">
                    <p>© 2026-2027 {appData.publishedBy.name}. All rights reserved.</p>
                </div>
            </div>
        </div>
    );
